...
<body>
    ...
    Anime Tracker, AI araclari kullanilarak gelistirilmis bir
    anime liste olusturma ve yayin takip sistemidir.
    <br><br>
    <a href="ai_notice.php" class="about-link">
        <i class="fas fa-robot"></i> AI Kullanim Beyani / Notice
    </a>
</p>
