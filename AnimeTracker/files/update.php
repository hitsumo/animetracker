...
$versionUrl = 'https://animetracker.sicakcikolata.com/version.txt';

// URL template for the downloadable ZIP. {VERSION} is substituted below.
$zipUrlTemplate = 'https://animetracker.sicakcikolata.com/updates/{VERSION}/anime-tracker-{VERSION}.zip';
