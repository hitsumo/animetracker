...
return [
    ...
    'help.blacklist.where'                   => 'Liste, yönetim panosundaki <strong>"İçe Aktarma Kara Listesi"</strong> sayfasındadır (moderatör ve üstü): başlık ya da kimlikle arama, <strong>"Listeden çıkar"</strong> ile geri alma. Engellenen bir animenin içe aktarımla yeniden önerilebilmesini istiyorsanız kaydı buradan çıkarın. Liste merkez kataloğa gitmez ve liste JSON yedeğine <strong>girmez</strong>; yedeği aynı sayfadaki <strong>"Dışa aktar"</strong> ile ayrı bir dosya olarak alınır ve <strong>"İçe aktar"</strong> ile geri yüklenir (yalnızca ekler, listede olanı atlar). Temiz kuruluma dönerken bu dosyayı ilk içe aktarımdan <strong>önce</strong> yükleyin; yoksa silinmiş animeler yeniden önerilir.',
