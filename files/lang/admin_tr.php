...
return [
    ...
    'admin_invites.generate.desc'            => 'Yeni bir tek kullanımlık davet kodu üretir. E-posta zorunludur: her davet bir alıcıya bağlanır (kod yine elle gönderilir, otomatik e-posta atılmaz).',
    'admin_invites.generate.email_label'     => 'E-posta (zorunlu)',
    'admin_invites.generate.err_email'       => 'Davet kodu üretmek için geçerli bir e-posta adresi girin.',
    ...
    'admin_invites.announce.label'           => 'Duyuru metni (Türkçe):',
    'admin_invites.announce.placeholder'     => 'Kayıt ekranında gösterilecek duyuru...',
    'admin_invites.announce.label_en'        => 'Duyuru metni (İngilizce):',
    'admin_invites.announce.placeholder_en'  => 'İngilizce arayüzde gösterilecek duyuru...',
    'admin_invites.announce.hint_en'         => 'İngilizce alan boş bırakılırsa, İngilizce arayüzde de Türkçe duyuru gösterilir.',
    ...
    // -----------------------------------------------------------------
    // admin_blacklist.php - Ice Aktarma Kara Listesi (1.1.35)
    // -----------------------------------------------------------------
    'admin_blacklist.page_title'            => 'İçe Aktarma Kara Listesi - Anime Tracker',
    'admin_blacklist.heading'               => 'İçe Aktarma Kara Listesi',
    'admin_blacklist.subtitle'              => 'Katalogdan silinen ve içe aktarımda geri gelmemesi gereken animeler',
    'admin_blacklist.intro'                 => 'Katalogdan bir anime sildiğinizde kimliği buraya kendiliğinden yazılır. Bu listedeki animeler AniList ve MyAnimeList içe aktarımlarında katalog önerisi olarak açılmaz. Fikrinizi değiştirirseniz satırı seçip listeden çıkarın; bir sonraki içe aktarımda yeniden gelebilir.',
    'admin_blacklist.localhost_only'        => 'Bu sayfa sadece localhost üzerinden erişilebilir.',
    'admin_blacklist.selfhost_note'         => 'Kara liste yalnızca çok kullanıcılı (online) modda etkindir. Tek kullanıcılı kurulumda paylaşılan bir katalog yoktur; silme kaydı tutulmaz ve içe aktarım hiçbir şeyi engellemez.',
    'admin_blacklist.empty'                 => 'Kara listede kayıt yok.',
    'admin_blacklist.empty_search'          => 'Aramanızla eşleşen kayıt yok.',
    'admin_blacklist.count'                 => 'Toplam %d kayıt',
    'admin_blacklist.paging'                => 'Sayfa %d / %d',
    'admin_blacklist.search.placeholder'    => 'Başlık ya da MAL / AniDB kimliği',
    'admin_blacklist.col.title'             => 'Anime',
    'admin_blacklist.col.external_ids'      => 'Dış kaynak ID',
    'admin_blacklist.col.reason'            => 'Kayıt',
    'admin_blacklist.col.state'             => 'Durum',
    'admin_blacklist.col.added_by'          => 'Ekleyen',
    'admin_blacklist.col.created'           => 'Tarih',
    'admin_blacklist.reason.deleted'        => 'Silindi',
    'admin_blacklist.reason.manual'         => 'Elle',
    'admin_blacklist.state.blocking'        => 'Engelliyor',
    'admin_blacklist.state.no_key'          => 'Engellemez',
    'admin_blacklist.state.no_key.hint'     => 'Bu kaydın MAL ya da AniDB kimliği yok; yalnızca silme kaydıdır, içe aktarımda eşleştirilecek bir anahtarı yoktur.',
    'admin_blacklist.state.in_catalog'      => 'Katalogda var',
    'admin_blacklist.state.in_catalog.hint' => 'Bu kimlik şu anda katalogda duruyor (silindikten sonra yeniden eklenmiş olabilir). Zararsızdır ama kaydı listeden çıkarmak karışıklığı önler.',
    'admin_blacklist.btn.remove'            => 'Listeden çıkar',
    'admin_blacklist.btn.select_all'        => 'Tümünü seç',
    'admin_blacklist.btn.clear_selection'   => 'Seçimi temizle',
    'admin_blacklist.btn.search'            => 'Ara',
    'admin_blacklist.btn.clear_search'      => 'Aramayı temizle',
    'admin_blacklist.btn.add'               => 'Kara listeye ekle',
    'admin_blacklist.confirm.remove'        => 'Seçili kayıtlar kara listeden çıkarılsın mı? Bu animeler bir sonraki içe aktarımda yeniden gelebilir.',
    'admin_blacklist.add.heading'           => 'Elle kayıt ekle',
    'admin_blacklist.add.hint'              => 'Hiç eklenmemiş bir animeyi baştan engellemek için. En az bir kimlik (MAL ya da AniDB) zorunludur; kimliksiz bir kayıt hiçbir şeyi engelleyemez.',
    'admin_blacklist.add.title'             => 'Anime adı',
    'admin_blacklist.add.mal_id'            => 'MAL ID',
    'admin_blacklist.add.anidb_id'          => 'AniDB ID',
    'admin_blacklist.add.note'              => 'Not (isteğe bağlı)',
    'admin_blacklist.error.csrf'            => 'Geçersiz güvenlik anahtarı (CSRF). Sayfayı yenileyip tekrar deneyin.',
    'admin_blacklist.error.inactive'        => 'Kara liste bu kurulumda etkin değil (yalnızca çok kullanıcılı mod).',
    'admin_blacklist.error.no_selection'    => 'Hiçbir kayıt seçilmedi.',
    'admin_blacklist.error.no_title'        => 'Anime adı boş bırakılamaz.',
    'admin_blacklist.error.no_id'           => 'En az bir kimlik girin (MAL ID ya da AniDB ID). Kimliksiz kayıt içe aktarımda hiçbir şeyi engellemez.',
    'admin_blacklist.error.add_failed'      => 'Kayıt eklenemedi. Sunucu günlüğüne bakın.',
    'admin_blacklist.error.unknown_action'  => 'Bilinmeyen işlem.',
    'admin_blacklist.error.table_missing'   => 'Kara liste tablosu okunamadı. 1.1.35 migration dosyası bu kurulumda henüz çalışmamış olabilir.',
    ...
    'admin.tool.blacklist.h3'               => 'İçe Aktarma Kara Listesi',
    'admin.tool.blacklist.desc'             => 'Katalogdan silinen animelerin defteri. Buradaki animeler AniList / MAL içe aktarımında katalog önerisi olarak geri gelmez.',
    'admin.tool.blacklist.link.open'        => 'Kara listeyi aç',
    'admin.tool.blacklist.link.count'       => '%d kaydı incele',
    'admin.tool.blacklist.missing_file'     => 'Eksik dosya:',
];
