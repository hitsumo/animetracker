...
return [
    ...
    'admin_invites.tab.invites'              => 'Davetler',
    'admin_invites.tab.requests'             => 'Davetiye Talepleri',
    'admin_invites.notify.h3'                => 'Bildirim E-postası',
    'admin_invites.notify.desc'              => 'Yeni bir davetiye talebi geldiğinde bilgilendirme e-postası bu adrese gönderilir (talep edenin e-postası ve nedeni). Boş bırakılırsa e-posta gönderilmez; talepler yine aşağıda görünür.',
    'admin_invites.notify.label'             => 'Bildirim adresi:',
    'admin_invites.notify.placeholder'       => 'ornek@alanadi.com',
    'admin_invites.notify.save'              => 'Kaydet',
    'admin_invites.notify.none'              => 'Bildirim adresi tanımlı değil. Talepler yalnızca bu sayfada görünür, e-posta gönderilmez.',
    'admin_invites.requests.h3'              => 'Bekleyen Talepler',
    'admin_invites.requests.empty'           => 'Henüz davetiye talebi yok.',
    'admin_invites.requests.col_email'       => 'E-posta',
    'admin_invites.requests.col_reason'      => 'Neden',
    'admin_invites.requests.col_date'        => 'Tarih',
    'admin_invites.requests.col_status'      => 'Durum',
    'admin_invites.requests.col_action'      => 'İşlem',
    'admin_invites.requests.status_pending'  => 'Bekliyor',
    'admin_invites.requests.status_invited'  => 'Davet edildi',
    'admin_invites.requests.status_rejected' => 'Reddedildi',
