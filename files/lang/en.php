...
return [
    ...
    'help.blacklist.where'                   => 'The list lives on the <strong>"Import Blacklist"</strong> page of the admin panel (moderators and above): search by title or id, undo with <strong>"Remove from list"</strong>. If you want a blocked anime to be suggested by imports again, remove its entry here. The list does not travel to the central catalog and is <strong>not</strong> part of the list JSON backup; back it up as a separate file with <strong>"Export"</strong> on the same page and restore it with <strong>"Import"</strong> (it only adds, skipping what is already listed). When returning to a clean install, load this file <strong>before</strong> the first import; otherwise deleted anime are suggested again.',
