...
<head>
    ...
    echo seo_head([
        'title'       => t('help.group.timezone.page_title'),
        'description' => sprintf(t('seo.help.group.description_fmt'), t('help.group.timezone.heading')),
        'canonical'   => 'help/help_timezone.php',
        'base'        => '../',
    ]);
    ?>
