...
<head>
    ...
    echo seo_head([
        'title'       => t('help.group.discovery.page_title'),
        'description' => sprintf(t('seo.help.group.description_fmt'), t('help.group.discovery.heading')),
        'canonical'   => 'help/help_discovery.php',
        'base'        => '../',
    ]);
    ?>
