...
// 1.1.3: drop adult-flagged sentences from the picker when adult content
// is off. An adult sentence therefore cannot be selected, so it also
// cannot appear in matched-tag results.
$allTags = adult_filter_terms($allTags);
